import 'package:space_app/PlanetData/PlanetModel.dart';

class PlanetData {
  // static PlanetModel earth = PlanetModel(
  //   planetName: 'Earth',
